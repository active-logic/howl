...
[.Net Core 3.1](https://dotnet.microsoft.com/download) is a pre-requisite.

Install scripts are on the way. In the meantime, building Howl [from source](LINK?) is not difficult (the library/console have no dependencies)
